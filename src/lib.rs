...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting Sorting processing");
    
    let mut processor = SortingProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SortingProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SortingProcessor::new(false);
